...
<html lang="en">
  ...
  <body>
      ...
      <ul class="nav">
          ...
          <li class="nav-item"><a class="nav-link" href="stringmanip.php">Simple String Manipulations</a></li>
          <li class="nav-item"><a class="nav-link" href="datetimemanip.php">Date and Time Manipulations</a></li>
